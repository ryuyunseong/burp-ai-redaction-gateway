...
| related indexes | preflight, handoff, prompt-readiness, evidence-boundary, operator-runbook, safe-files, triage, report-readiness, review/report/export flow 링크 |
...
| operator-runbook | 수집부터 AI 투입 전 수동 검토까지 운영 순서 확인 |
| safe-files | safe files 4개의 존재 여부와 fingerprint 확인 |
