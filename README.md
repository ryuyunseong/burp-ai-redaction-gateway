...
operations, GUI audit panel interpretation, and risk rating guide entry points
without adding form, POST, archive/HMAC action, risk profile action, replay,
active scan, delete, or edit controls.
